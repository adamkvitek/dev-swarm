...
export const TOOL_DEFINITIONS = {
  ...
  spawn_council: {
    description:
      "Spawn a COUNCIL of workers — multiple AI models (Claude + Codex + Gemini) implement each subtask independently in parallel. Use for critical tasks where you want multiple perspectives. Costs ~2-3x more than spawn_workers. Returns a job_id.",
    inputSchema: {
      channel_id: z.string().describe("Discord channel ID for this job"),
      subtasks: z
        .array(
