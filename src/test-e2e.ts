...
async function main(): Promise<void> {
  ...
  const request = `In /Users/you/projects/documentation-portal on branch feature/verify-code-samples-v2, read the phase docs and create a task plan for the proposed functionality.`;
